...
const Home = () => {
  ...
  return (
    <div name='home' className='relative py-3 px-[3%] md:py-4 md:px-[11%] flex md:grid flex-col gap-5 text-center md:text-left mt-40 md:mt-14 w-full md:grid-cols-2 md:gap-10 items-center justify-center'>
      {/* Container */}
      <div>
        <h2 className='text-2xl md:text-3xl font-semibold md:font-medium mt-0 mx-0 mb-5'>Hello👋, I'm</h2>
        <h1 className='text-5xl md:text-6xl font-bold md:font-semibold mt-0 mx-0 mb-5'>Hizkia Reppi</h1>
        <h3 className='text-xl md:text-2xl font-semibold md:font-medium mb-6'> I'm <span className='text-second'>{text}</span></h3>
